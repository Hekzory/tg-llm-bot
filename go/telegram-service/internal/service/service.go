...
func (s *UserService) IsUserExist(ctx context.Context, tg_id int) (bool, error) {
	return s.userRepo.IsUserExist(&models.User{TelegramID: tg_id})
}

func (s *UserService) AddUser(ctx context.Context, tg_id int) error {
